    ...
    return (
      <nav className={styles.nav}>
        <ul className={styles.ul}>
          ...
          <li>
            <a href="/webinars" className={`${styles.link} ${pathname.startsWith('/webinars') ? styles.active : ''}`}>
              <svg className='icon' xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
          ...
          <li>
            <a href="/contourings" className={`${styles.link} ${pathname.startsWith('/contourings') ? styles.active : ''}`}>
              <svg className='icon' xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
          ...
          <li>
            <a href="/profile" className={`${styles.link} ${pathname.startsWith('/profile') ? styles.active : ''}`}>
              <svg className='icon' xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
